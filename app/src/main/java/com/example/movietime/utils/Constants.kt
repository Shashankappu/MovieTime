...
val dummyMovies = listOf(
    Movie(
        ...
        runtime = 175,
        yearOfRelease = 1983,
        genres = listOf(Genre(1, "Crime"), Genre(2, "Drama")),
        adult = true,
        ...
        releaseDate = LocalDate.of(1983, 3, 24),
    ...
    Movie(
        ...
        releaseDate = LocalDate.of(2010, 5, 25),
    ...
    Movie(
        ...
        releaseDate = LocalDate.of(2001, 9, 15),
    ...
    Movie(
        ...
        releaseDate = LocalDate.of(2019, 5, 2),
    ...
    Movie(
        ...
        releaseDate = LocalDate.of(2016, 12, 18),
